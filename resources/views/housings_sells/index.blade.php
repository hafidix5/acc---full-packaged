...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Housings Sells</h4>
            </div>
        ...
        @if(count($housingsSellsObjects) == 0)
            <div class="panel-body text-center">
                <h4>No Housings Sells Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($housingsSellsObjects as $housingsSells)
                        <tr>
                            <td>{{ optional($housingsSells->HousingsEggsorted)->total }}</td>
                            <td>{{ optional($housingsSells->HousingsEggsorted)->total }}</td>
                            <td>{{ optional($housingsSells->HousingsEggsorted)->total }}</td>
                            <td>{{ optional($housingsSells->HousingsEggsorted)->total }}</td>
                            <td>{{ $housingsSells->category }}</td>
                            <td>{{ $housingsSells->price }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('housings_sells.housings_sells.show', $housingsSells->id ) }}" class="btn btn-info" title="Show Housings Sells">
