...
class Housings extends Model
{
    ...
    */
    ...
    {
        return $this->hasOne('App\Models\housings_eggsorteds','housings_id','id');
    }
    ...
    {
        return $this->hasOne('App\Models\housings_givefeeds','housing_id','id');
    }
    ...
    {
        return $this->hasOne('App\Models\housings_givetreatments','housing_id','id');
    }
    ...
    {
        return $this->hasOne('App\Models\housings_hasroles','housing_id','id');
    }
